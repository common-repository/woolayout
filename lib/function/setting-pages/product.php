...
function woolayout_product_layout_settings() {
...
if ( isset($_POST['reset-product-page'])  && check_admin_referer( 'woolayout_product_nonce_action', 'woolayout_product_nonce_fied' ) ) {
	// process form data

 update_option('woolayout_product_woo_elements_lists', reset_woolayout_product_woo_elements_lists() );
 
 update_option('woolayout-product-page-sections', reset_woolayout_product_page_sections() );
  //echo '<p style="color:green">Settings have been reset and default values loaded</p>'; 
}
?>
...
<div class="woolayout-settings-wrap woolayout-product-page-layout">
...
<div class="woolayout-button-wrap"> 
	...
	<form method="post" action="" class="woolayout-reset-form">
							 <p class="submit">
							 <input name="reset-product-page" class="button button-primary" type="submit" value="Reset to Woocommerce Default Layout" >
							 <input type="hidden" name="action" value="reset-product-page" />
								<?php wp_nonce_field( 'woolayout_product_nonce_action', 'woolayout_product_nonce_fied' ); ?>
							 </p>
						</form>
...
<h1> WooCommerce Single Product Page Layout </h1>
	...
	<div class="woolayout-elements-list woolayout-tabs">
			...
			<div id="woolayout-tab1" class="woolayout-tab-content"> 
				<h2> General Elements </h2>
								...
								<div class="woolayout-tabs">								
										...
										<div id="<?php echo $sections; ?>-tab2">
														...
														<div class="woolayout-filed-wrap"> 
																...
																<div class="woolayout-filed-container"> 
																	<input class="woolayout-elements-on-hover" type="checkbox" name="<?php echo $sections; ?>-settings[display_elements_on_hover]" value="display-elements-on-hover" <?php if ( 'display-elements-on-hover' == $sections_settings['display_elements_on_hover'] ) echo 'checked="checked"'; ?> >
																</div>
														</div>
														<div class="woolayout-filed-wrap"> 
					...
					<div class="woolayout-drag-items woolayout-add-columns">
			...
			<div id="woolayout-tab2" class="woolayout-tab-content"> 
				...
				<p> Drag and Drop the Woocommerce Elements inside the column </p>
					...
					<div id="woolayout_product_woo_elements_lists" class="woolayout-default-woo-elements">
					
						<?php 
						
						$woolayout_woo_elements_lists = get_option("woolayout_product_woo_elements_lists");
			...
			<div id="woolayout-tab3" class="woolayout-tab-content"> 
					...
					<h2> Woolayout Template </h2>
					 ...
					 <h4> This Settings is available only in <a target="_blank" href="http://framepressstudio.com/product/woocommerce-layout-pro/"> Woolayout PRO </a>  </h4>
						...
						<form method="post" action="" class="woolayout-reset-form">
							 <p class="submit">
							 <input name="product-single-column-layout" class="woolayout-template-button" type="submit" value="Single Column Layout" >
							 <input type="hidden" name="action" value="product-single-column-layout"/>
							 </p>
						</form>
						
						<form method="post" action="" class="woolayout-reset-form">
							 <p class="submit">
							 <input name="product-left-details-layout" class="woolayout-template-button" type="submit" value="Left Details Layout" >
							 <input type="hidden" name="action" value="product-left-details-layout"/>
							 </p>
						</form>
						
						<form method="post" action="" class="woolayout-reset-form">
							 <p class="submit">
							 <input name="product-three-column-layout" class="woolayout-template-button" type="submit" value="Three Column Layout" >
							 <input type="hidden" name="action" value="product-three-column-layout"/>
							 </p>
						</form>
  ...
  <form method="post" action="options.php" id="woolayout-product-pages">

    <?php settings_fields( 'woolayout_single_product_settings_group' ); ?>

    <?php do_settings_sections( 'woolayout_single_product_settings_group' ); ?>
 
 

	<div class="woolayout-content-wrap">
	<div id="woolayout-product-page-sections" class="woolayout-content-container">	
		...
		<div id="<?php echo $sections; ?>" class="woolayout-sections">
			...
			<?php
							...
							foreach ( (array) $column_list as $count_column => $column) {
								...
								$column_css = $column_settings["css"];
