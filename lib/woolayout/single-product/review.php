...
add_shortcode( 'woolayout_product_review', 'woolayout_product_review_shortcode' );

function woolayout_product_review_shortcode ( $atts ) {
...
<li itemprop="reviews" itemscope itemtype="http://schema.org/Review" <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
	...
	<?php
	// end woolayout_product_review_shortcode
	}
?>